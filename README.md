...
![Pipeline](docs/report/assets/pipeline.png)
...
- **Deliverables:** reproducible scripts, experiment assets, visualizations, technical notes, and a final technical report.
...
![Dataset EDA](docs/report/assets/dataset_eda.png)
...
- [Environment and data](docs/environment_and_data.md)
...
![Qualitative Results](docs/report/assets/qualitative_results.jpg)

Related notes:

- [Detection training](docs/detection_training.md)
- [Detection evaluation](docs/model_evaluation.md)
- [Lightweight model comparison](docs/lightweight_model_comparison.md)
- [MobileNet aerial balanced experiment](docs/mobilenet_aerial_balanced.md)
...
![Small Object Tradeoff](docs/report/assets/small_object_tradeoff.png)
...
- [Small-object ablation](docs/yolo_small_object_ablation.md)
- [MobileNet small-object ablation](docs/mobilenet_small_object_ablation.md)
...
![Tracker Comparison](docs/report/assets/tracker_comparison.png)
...
- [Tracking baseline](docs/tracking_baseline.md)
...
![Distillation Comparison](docs/report/assets/distillation_comparison.png)
...
- [YOLO distillation](docs/yolo_distillation.md)
...
![Deployment Tradeoff](docs/report/assets/deployment_tradeoff.png)
...
- [TensorRT INT8 benchmark](docs/tensorrt_int8_benchmark.md)
- [INT8 scene calibration](docs/int8_scene_calibration.md)
- [Runtime memory benchmark](docs/runtime_memory_benchmark.md)
...
| `scripts/reports/build_technical_report.py` | Rebuild the final technical report |
...
- [Environment and data](docs/environment_and_data.md)
- [Detection training](docs/detection_training.md)
- [Tracking](docs/tracking_baseline.md)
- [ONNX export](docs/onnx_export.md)
- [Lightweight comparison](docs/lightweight_model_comparison.md)
- [Pruning experiment](docs/pruning_experiment.md)
- [TensorRT and INT8](docs/tensorrt_int8_benchmark.md)
- [Distillation](docs/yolo_distillation.md)
- [Final technical report](docs/report/uav_vision_technical_report.pdf)
...
Small curated figures and CSV summaries used by the documentation are tracked under `docs/assets/` and `docs/report/assets/`.

## Final Deliverable

The final technical report summarizes the full measured workflow, including detection, tracking, small-object ablation, model compression, distillation, ONNX/TensorRT deployment, and integrated demo results.

- [Technical report DOCX](docs/report/uav_vision_technical_report.docx)
- [Technical report PDF](docs/report/uav_vision_technical_report.pdf)
